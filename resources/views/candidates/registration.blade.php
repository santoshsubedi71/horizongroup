                        ...
                        <div class="d-flex flex-wrap">
                            <div class="d-flex w-100 p-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="firstName" name="firstName" value="{{ old('firstName') }}" placeholder="例　山田">
                                    </div>
                                    @error('firstName')
                            ...
                            <div class="d-flex w-100 p-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="メールアドレス入力して下さい">
                                    </div>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="d-flex w-100 p-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address" value="{{ old('address') }}" placeholder="住所入力して下さい">
                                    </div>
                                    @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jlptLevel">
                                        ...
                                        @foreach (App\Enums\jlptLevel::cases() as $jlptLevel)
                                            <option value="{{ $jlptLevel->value }}" {{ old('jlptLevel') == $jlptLevel->value ? 'selected' : '' }}>
                            ...
                            <div class="d-flex w-100 p-2">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="workExperence" rows="5"
                                        placeholder="
                                    アルバイト=> セブンイレブン新宿３丁目店
                                    正社員 => sample株式会社">{{ old('workExperence') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <!-- Empty Field -->
                                </div>
                            ...
                            <div class="d-flex w-100 p-2">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="memo" rows="5" placeholder="メーモ">{{ old('memo') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <!-- Empty Field -->
                                </div>
